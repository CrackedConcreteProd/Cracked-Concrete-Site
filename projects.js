...
const PROJECTS = [
  ...
  },
  {
    ...
    credits: [
      ...
      ["Cinematographer", "Ben Mouland"],
      ["PRODUCER", "Nushi Sharma"],
      ["Editor", "Ngaire Lyden-Elleray"],
    ],
    links: [
      ["IMDB", "#"],
    ],
  },
  {
    ...
    credits: [
      ...
      ["Producer", "Alexandra Sirola"],
      ["Editor", "Ben Mouland"],
      ["Sound Design", "Ben Mouland"],
    ],
    links: [
      ["IMDB", "https://www.imdb.com/title/tt27003046/?ref_=ext_shr_lnk"],
      ["Letterboxd", "https://boxd.it/J98W"]
    ],
  },
  {
    slug: "project-07",
    ...
    credits: [
      ["DIRECTOR", "Lewen Han"],
      ["Cinematographer", "Ben Mouland"],
      ["Writer(s)", "Lucy Jeffrey, Sewit Eden Haile, Oscar Mather"],
      ["Editor", "Koyo Matsui"],
      ["HMU", "Grace Shore"],
    ],
    links: [
      ["IMDB", "https://www.imdb.com/title/tt37727761/?ref_=ext_shr_lnk"],
    ],
  },
  // ===== MUSIC VIDEOS =====
  {
    ...
    stills: [],
    credits: [
      ["ARTIST", "Spank Williams"],
      ["DIRECTOR", "Koby Cobb-Vialet"],
      ["Cinematographer", "Ben Mouland"],
      ["PRODUCER(s)", "Natasha Roussopoulos & Arkin Pal"],
      ["Editor", "Koby Cobb-Vialet"],
      ["Colourist", "Tristan Ramos"],
    ],
    links: [
      ["WATCH", "https://youtu.be/MlJhP0whbpg?si=WcPKNM-yar-vZSSL"],
    ],
  },
  {
    slug: "mv-02",
    ...
    links: [
      ["WATCH", "https://youtu.be/n6JCjguvtso?si=_Slnik3Nsxzhg9BH"],
    ],
  },
  {
    slug: "mv-03",
    ...
    links: [
      ["WATCH", "https://youtu.be/fkZEgZCAHQk?si=hMjqkW_xDtAe-r04"],
    ],
  },
  {
    slug: "mv-04",
  ...
  },
  {
    ...
    links: [
      ["WATCH", "https://youtu.be/5v3Ny9vNMRg?si=xm19BGQ-ltJt7591"],
    ],
  },
  {
    slug: "mv-06",
    ...
    links: [
      ["WATCH", "https://youtu.be/pD5ug8Eysq4?si=58ejSPBaGUwiF6ws"],
    ],
  },
  // ===== LIVE SESSIONS =====
  {
